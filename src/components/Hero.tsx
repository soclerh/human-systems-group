            ...
            <div className="max-w-7xl mx-auto w-full relative z-10 pt-20">
                <div className="max-w-3xl">
                    ...
                    <p className="text-xl md:text-2xl text-slate-600 font-light leading-relaxed mb-12">
                        Human Systems Group designs human infrastructures combining organizational engineering, digital systems, and ecosystem platforms.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="#approach" className="bg-[#0A1128] text-white px-8 py-4 flex items-center gap-4 hover:bg-black transition-colors group">
                            <span className="uppercase text-xs tracking-widest font-bold">Explore the approach</span>
                            <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                        </a>
                        <a href="#brands" className="border border-[#0A1128] text-[#0A1128] px-8 py-4 flex items-center gap-4 hover:bg-[#0A1128] hover:text-white transition-all group">
                            <span className="uppercase text-xs tracking-widest font-bold">View the brands</span>
                        </a>
                    </div>
                </div>
            </div>
