            ...
            <div className="max-w-7xl mx-auto">
                <div className="border border-slate-200 p-12 md:p-24 relative overflow-hidden bg-slate-50 text-[#0A1128]">
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-5xl font-bold tracking-tighter uppercase mb-6">Get in <span>touch</span></h2>
                            <p className="text-lg text-slate-600 mb-8 max-w-md font-medium">
                                For strategic requests, partnerships, or institutional inquiries, our steering team is available for targeted dialogue.
                            </p>
                            <div className="space-y-4">
                                <div className="text-xs uppercase tracking-widest font-black text-[#C5A059]">Direct Communication</div>
                                <a href="mailto:contact@humansystemsgroup.com" className="text-2xl font-light hover:text-[#C5A059] transition-colors border-b border-white/20 pb-2 inline-block">
